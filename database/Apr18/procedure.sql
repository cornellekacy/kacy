...
CREATE PROCEDURE changeUserPassword(p_username VARCHAR(45), p_password VARCHAR(255))
BEGIN
	UPDATE users
...
CREATE PROCEDURE getClasslistperclass(IN p_classroom_id INT, IN p_academic_id INT)
BEGIN 
	SELECT 
