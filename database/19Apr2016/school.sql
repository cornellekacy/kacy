...
CREATE TABLE IF NOT EXISTS `attendance` (
  ...
  `attended` TINYINT(1) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `exam_result` (
  `examtypeId` INT NOT NULL COMMENT '',
  `student_id` INT NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `examtimetable` (
  ...
  `exam_type_id` INT NOT NULL DEFAULT '1' COMMENT '',
...
CREATE TABLE IF NOT EXISTS `g_related_s` (
  ...
  `student_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`guardianId`, `relationship_id`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `grade` (
  `gradeId` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `name` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `subjects_has_grade` (
  ...
  `classes_of_class_classId` INT NOT NULL COMMENT '',
  PRIMARY KEY (`subjects_id`, `grade_id`, `classes_of_class_classId`)  COMMENT '',
  ...
  INDEX `fk_subjects_has_grade_classroom1_idx` (`classes_of_class_classId` ASC)  COMMENT '',
  CONSTRAINT `fk_subjects_has_grade_classroom1`
    FOREIGN KEY (`classes_of_class_classId`)
    REFERENCES `classes_of_class` (`classId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `userlog_time` (
  ...
  `users_password` VARCHAR(255) NOT NULL COMMENT '',
  `LoginTime` VARCHAR(45) NOT NULL COMMENT '',
  `LogoutTime` DATETIME NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`LoginTime`, `users_password`, `users_username`)  COMMENT '',
  INDEX `fk_userlog_time_users1_idx` (`users_username` ASC, `users_password` ASC)  COMMENT '',
  CONSTRAINT `fk_userlog_time_users1`
    FOREIGN KEY (`users_username` , `users_password`)
    REFERENCES `users` (`username` , `password`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
